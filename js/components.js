...
function inject(){loadTheme();const s=document.getElementById('sidebar-mount');if(s)s.outerHTML=`<aside class="sidebar" id="sidebar">${buildSidebar()}</aside>`;const t=document.getElementById('topbar-mount');if(t)t.outerHTML=buildTopBar();const b=document.getElementById('bottomnav-mount');if(b)b.outerHTML='';const o=document.getElementById('overlay-mount');if(o)o.outerHTML='<div id="sidebarOverlay" class="sidebar-overlay"></div>';const sc=document.getElementById('scrolltop-mount');if(sc)sc.outerHTML='<button id="scrollTopBtn" class="scroll-top-btn" aria-label="Scroll to top">↑</button>';const f=document.getElementById('footer-mount');if(f)f.outerHTML='<footer class="site-footer"><div><strong>LogicLab</strong> <span class="footer-version">v3.4</span></div><div style="margin-top:.45rem">Digital Electronics Laboratory</div><div style="margin-top:.35rem;font-size:.72rem;opacity:.65">Learn • Simulate • Practice</div></footer>'}
